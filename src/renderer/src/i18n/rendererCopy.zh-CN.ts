...
export const zhCN = {
  ...
  "sidebar.closeAgent": "关闭 Agent",
	"sidebar.deleteSession": "删除会话",
	"sidebar.confirmDeleteSession": "确定删除这个会话及其关联的所有子会话吗？",
	"sidebar.sessionActivating": "会话正在激活中...",
  ...
  "app.imagePreviewPrevious": "上一张",
  "app.imagePreviewNext": "下一张",
  "app.imagePreviewAlt": "图片预览",
  "app.imagePreviewOpenInSystem": "使用系统默认程序打开",
  "app.imagePreviewOpening": "正在打开…",
  "app.imagePreviewOpenInSystemFailed": "无法使用系统默认程序打开",
  "app.fileLinkFormatInvalid": "文件链接格式无效",
  "app.imageNotFoundOrEmpty": "文件不存在、为空或无法读取",
  "app.imagePermissionDenied": "无权访问该文件",
  "app.imageReadFailed": "读取图片失败",
  "app.imageCorruptedOrUnsupported": "图片损坏或格式不受支持",
  "app.imageReadFormatError": "读取结果格式错误",
  "app.imageRemove": "移除图片",
  "app.imageTooLarge": "图片过大，最大支持 10MB",
  "app.clipboardImageUnavailable": "剪贴板图片无法加载，可能超过原生剪贴板传输限制",
  ...
  "composer.images.tooManyFiles": "单次最多只能选择 {max} 张图片",
  "composer.images.pickerFailed": "图片选择失败，请重试",
  "composer.images.decodeFailed": "无法解码图片文件，请检查文件是否损坏",
  "composer.images.resendBudgetExceeded": "待重发消息包含的图片超出大小上限（24MB），无法重发",
  "composer.images.allFailed": "所选图片均未能成功读取或解析",
  "composer.images.partialFailed": "{count} 张图片读取或解析失败已跳过",
  "composer.images.budgetExceeded": "图片总大小超出 24MB 限制，仅添加了前 {added} 张（共 {total} 张）",
  "composer.modelNotice.visionBridge": "当前模型通过视觉桥接将图片转为文本描述",
  "composer.modelNotice.suggestVision": "当前模型不支持图片输入，建议切换具备视觉能力的模型或配置视觉桥接",
  "composer.modelNotice.unknownCapability": "当前模型图片输入能力未知",
  "tool.images.count": "{count} 张图片",
  "tool.images.notice.tooLarge": "部分图片因单张体积超过 4MB 未予展示",
  "tool.images.notice.tooMany": "图片数量超出 8 张上限，已仅展示前 {count} 张（已省略 {omitted} 张）",
  "tool.images.notice.runtimeBudget": "该工具调用的图片已从内存释放以保障性能",
  "tool.images.notice.deliveryBudget": "图片载荷超出单次传输限制，已在此批次中省略展示",
  ...
  "session.messageDeliveryTooLarge": "消息包体积超过传输限制，已跳过本次投递。请减少单次工具输出或分批处理。",
  ...
  "security.enabledHint": "开启后，pi agent 的受管工具调用将按等级策略拦截或要求确认；关闭时完全放行（默认，零干预）。规则在下一次工具调用时生效。",
  ...
  "security.menuHint": "为当前会话选择生效等级，下一次工具调用时生效",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "prompt.commands": "命令",
  "prompt.confirmHint": "Tab 确认",
  "prompt.files": "文件",
  "prompt.referencePath": "引用此路径",
  "prompt.sessions": "会话",
  ...
  "settings.sectionAboutDesc": "0.2.1 移除了内置更新检查。新版本发布后，请到 GitHub Releases 手动下载。",
  "settings.viewReleases": "查看 Releases",
  ...
  "timeline.loadEarlierContent": "显示更早内容",
  ...
  "ctx.switches.keepRecentTooltip": "最近 N 次工具结果共用一个计数窗口完整保留进上下文。更早的结果按右侧开关处理：打开则保留，关闭则截断或换成占位。",
  "ctx.switches.keepRecentAllKeptReason": "当前保留所有工具内容，此数值暂不生效。关闭任一内容保留开关后可设置。",
