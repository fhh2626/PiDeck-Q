...
export const enUS: Record<TranslationKey, string> = {
  ...
  "sidebar.closeAgent": "Close agent",
	"sidebar.deleteSession": "Delete session",
	"sidebar.confirmDeleteSession": "Delete this session and any associated child sessions?",
	"sidebar.sessionActivating": "Session is activating...",
  ...
  "app.imagePreviewPrevious": "Previous image",
  "app.imagePreviewNext": "Next image",
  "app.imagePreviewAlt": "Image preview",
  "app.imagePreviewOpenInSystem": "Open with default application",
  "app.imagePreviewOpening": "Opening…",
  "app.imagePreviewOpenInSystemFailed": "Failed to open with default application",
  "app.fileLinkFormatInvalid": "Invalid file link format",
  "app.imageNotFoundOrEmpty": "File does not exist, is empty, or could not be read",
  "app.imagePermissionDenied": "Permission denied accessing this file",
  "app.imageReadFailed": "Failed to read image",
  "app.imageCorruptedOrUnsupported": "Image is corrupted or in an unsupported format",
  "app.imageReadFormatError": "Invalid file read result format",
  "app.imageRemove": "Remove image",
  "app.imageTooLarge": "Image is too large. Maximum size is 10MB.",
  "app.clipboardImageUnavailable": "The clipboard image could not be loaded. It may be too large for the native clipboard transport.",
  ...
  "composer.images.tooManyFiles": "You can only select up to {max} images at once",
  "composer.images.pickerFailed": "Failed to open image picker, please try again",
  "composer.images.decodeFailed": "Failed to decode image file, please verify the file is not corrupted",
  "composer.images.resendBudgetExceeded": "The images in this message exceed the 24MB attachment limit and cannot be resent",
  "composer.images.allFailed": "Failed to read or decode any of the selected images",
  "composer.images.partialFailed": "{count} images failed to load and were skipped",
  "composer.images.budgetExceeded": "Total image size exceeds 24MB budget; only added first {added} of {total} images",
  "composer.modelNotice.visionBridge": "Current model converts images to text descriptions via Vision Bridge",
  "composer.modelNotice.suggestVision": "Current model does not support image input. Consider switching to a vision-capable model or configuring Vision Bridge",
  "composer.modelNotice.unknownCapability": "Current model image capability is unknown",
  "tool.images.count": "{count} images",
  "tool.images.notice.tooLarge": "Some images were omitted because single image size exceeds 4MB",
  "tool.images.notice.tooMany": "Image count exceeds the 8-image limit; displaying first {count} images ({omitted} omitted)",
  "tool.images.notice.runtimeBudget": "Images from this tool call have been freed from memory to optimize performance",
  "tool.images.notice.deliveryBudget": "Image payload exceeds the batch transfer limit and was omitted",
  ...
  "session.messageDeliveryTooLarge": "Message payload exceeds the transfer limit. Delivery was skipped. Please reduce tool output or batch the operation.",
  ...
  "security.enabledHint": "When enabled, managed pi agent tool calls are gated or require confirmation per level rules; when disabled everything passes through (default, zero interference). Rule changes apply on the next tool call.",
  ...
  "security.menuHint": "Choose the level for this session; rule changes apply on the next tool call",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.sectionAboutDesc": "Built-in update checking was removed in 0.2.1. Grab the latest build from GitHub Releases when it ships.",
  ...
  "timeline.loadEarlierContent": "Show earlier content",
  ...
  "ctx.switches.keepRecentTooltip": "Keep the last N tool results verbatim in a shared count window. Older results follow the switches: on keeps them, off trims or stubs them.",
  "ctx.switches.keepRecentAllKeptReason": "All tool contents are currently kept, so this value has no effect. Turn off either content switch to edit it.",
